...
- [x] **MAC-04**: SDL2 gamepad (PS4/PS5/Xbox) works on macOS — controller detected, all buttons and axes functional
- [x] **MAC-05**: Inno Setup configure_file in CMakeLists.txt wrapped in `if(WIN32)` — Mac `cmake` configure runs clean with no errors
...
| MAC-04 | Phase 46 | Complete |
| MAC-05 | Phase 46 | Complete |
